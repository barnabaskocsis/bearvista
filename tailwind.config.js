...
module.exports = {
  ...
  theme: {
    extend: {
      backgroundImage: {
        'nav-button-gradient': 'linear-gradient(90deg, #D84A4A, #D04B6C, #C04A5A)',
        'sunset-gradient': 'linear-gradient(90deg, #FF5F6D, #FFC371)',
        'custom-gradient': 'linear-gradient(90deg, #FF7E5F, #FF6A6A, #E52A5A)'
      },
